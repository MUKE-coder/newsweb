    ...
    <div className='px-4 mt-10'>
      ...
      <div className='bg-[#f5f5f5] px-4 py-6 text-center rounded-lg flex flex-col gap-3'>
        <div className='lg:text-[1rem] md:text-[1rem] text-[0.7rem]'>
          <h3>WELCOME TO LUBILIIZI BULLETIN</h3>
        </div>
        <div className='flex flex-col gap-3'>
          <h2 className='lg:text-[1.5rem] md:text-[1.3rem] text-[1rem] font-bold'>Craft <span className='text-[#e5101a]'>narratives</span> ✍🏻 that ignite <span className='text-[#e5101a]'>inspiration</span>💡,</h2>
